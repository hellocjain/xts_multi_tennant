...
# 3. Mini Commodity Aliases
assert xts_api.COMMON_ALIASES.get("ZINCMINI") is None, "ZINCMINI alias not removed"
assert xts_api.COMMON_ALIASES.get("LEADMINI") is None, "LEADMINI alias not removed"
