...
MIN_DAYS_BEFORE_EXPIRY_MCX_NCDEX = int(os.environ.get("MIN_DAYS_BEFORE_EXPIRY_MCX_NCDEX", "3"))
...
BACKGROUND_THREAD_POOL_SIZE = int(os.environ.get("BACKGROUND_THREAD_POOL_SIZE", "100"))
